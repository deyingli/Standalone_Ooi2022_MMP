...
% for behid = 1:58
% % read each beh
% beh_father = 'D:\Data\2022\Mar\KRR_data\beh_data';
% beh_path = ['D:\Data\2022\Mar\KRR_data\beh_data\beh_reg_ICDF_922_' num2str(behid) '.txt'];
% scores = load(beh_path);
% save('D:\Data\2022\Mar\KRR_data\scores.csv', 'scores');
for i = 1:60
...
scorecsv = 'D:\Data\2022\Mar\KRR_data\scores.csv'; % 行为，921*58
restrictedcsv = 'D:\Data\2022\Mar\KRR_data\HCP_restricted.csv'; % 年龄和家庭信息
predvar = 'D:\Data\2022\Mar\KRR_data\prediction_variables.txt'; % 行为的名字
covtxt = 'output_cov.mat'; % 需要回归的变量，921*10(5 scores)
ymat = 'output_y.mat';
...
if ~exist(fullfile(outdir, y_mat))
    ...
    % y = CBIG_read_y_from_csv(score_csv, 'Subject', score_names, score_types, sub_txt, fullfile(outdir, y_mat), ',');
    y = load('D:\Data\2022\Mar\KRR_data\scores.txt');
else
...
% end
cov = load('D:\Data\2022\Mar\KRR_data\output_cov.mat');
